...
const Header = () => {
    return (
        <header>
        <div className="triangleSmall"></div>
        ...
        <div className="triangle">
          ...
          <p>
            I'm an Information Systems Engineer, passionate about programming
            and eager to learn. Currently studying Deep Learning
          </p>
          <p>
          I love creating solutions to real life necessities and providing tools to improve people's lives
          </p>
        </div>
